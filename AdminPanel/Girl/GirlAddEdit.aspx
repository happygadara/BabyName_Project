<%@ Page Title="" Language="C#" MasterPageFile="~/Content/BabyName.master" AutoEventWireup="true" CodeFile="GirlAddEdit.aspx.cs" Inherits="AdminPanel_Girl_GirlAddEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <asp:TextBox ID="txtGirlName" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div></div><br />
